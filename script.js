function Empezar() {
  ...
  class gameOfLife {
    ...
    crearTablero(numero_columnas, numero_filas) {
      for (let x = 0; x < numero_filas; x++) {
        const jugadorX = document.getElementsByClassName(
          "gameoflife__cuadricula"
        );
        ...
        for (let y = 0; y < numero_columnas; y++) {
          const jugadorY =
            document.getElementsByClassName("gameoflife__cell-x");
  ...
  console.table(partidaGameOfLife);
  partidaGameOfLife.crearTablero(numero_filas, numero_columnas);
}
